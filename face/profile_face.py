...
class ProfileFace():
    ...
    def create(self, master):
        ...
        # create_settings_lab(self.profile_face, name="setting") \
        #     .grid(row=0, column=2, columnspan=3, sticky=W)

        # create_face_label(self.profile_face, name="setting").grid(row=0, column=2, columnspan=3, sticky=W)
        # self.profile_face_club_btn = create_home_btn(self.profile_face, name=f"{ClubId}:{self.club_id}",
        #                                              commd=self.go_to_set_clubid)
        # self.profile_face_club_btn.grid(row=1, column=2, columnspan=2, sticky=W)
        #
        #
        #
        # self.profile_face_exchange_btn = create_home_btn(self.profile_face,
        #                                                  name=f"{Exchange}:\n{self.exchange_money} USD = {self.exchange_chips} Chips",
        #                                                  commd=self.go_to_set_exchange)
        # self.profile_face_exchange_btn.grid(row=2, column=2, columnspan=2, sticky=W)
        #
        # self.profile_face_mail_btn = create_home_btn(self.profile_face,
        #                                              name=f"{Email}:\n{self.email}",
        #                                              commd=self.go_to_set_email)
        # self.profile_face_mail_btn.grid(row=3, column=2, columnspan=2, sticky=W)
        ...
        self.profile_face_label02 = create_profile_face_label(self.profile_face, name=f"  {Exchange}:{self.exchange_money} USD = {self.exchange_chips} Chips")
        # self.profile_face_label02.bind('<Button-1>', func=self.go_to_set_exchange)
        ...
        # self.profile_face_label03.bind('<Button-1>', func=self.go_to_set_email)
        ...
        # self.profile_face_useless_lab1 = Label(self.profile_face,text="      ",bg='#f0f0f0')
        # self.profile_face_useless_lab1.grid(row=1, column=1, rowspan=4)
        # self.profile_face_useless_lab2 = Label(self.profile_face,text="      ",bg='#f0f0f0')
        # self.profile_face_useless_lab2.grid(row=1, column=3, rowspan=4)
    ...
    def go_to_set_exchange(self,event):
        ...
        self.money_entry.grid(row=1, column=1, sticky=S, pady=15)
        ...
        self.chips_entry.grid(row=1, column=3, sticky=S, pady=15)
        ...
        self.confirm_btn.grid(row=2, column=1, columnspan=4, sticky=W + E, padx=5, pady=25)
